...
def lagrange_F(U2: ArrayLike, r0: ArrayLike = 1) -> ArrayLike:
...
def lagrange_G(
    ...
    """
    return (r0 * U1 + sigma0 * U2) / jnp.sqrt(mu)


def lagrange_Ft(
    U1: ArrayLike, r: ArrayLike, r0: ArrayLike = 1, mu: ArrayLike = 1
) -> Array:
    r"""The Lagrange Ft function

    Args:
        U1: The universal function U1.
        r: The radius at the current time.
        r0: The radius at the initial time.
        mu: The gravitational parameter.
    ...
    Examples:
        ...
        Array([1., 2.], dtype=float32)
    """
    return jnp.sqrt(mu) / r / r0 * U1


def lagrange_Gt(U2: ArrayLike, r: ArrayLike) -> ArrayLike:
...
# def prpr0(r_vec:ArrayLike,v_vec:ArrayLike,r0_vec:ArrayLike,v0_vec:ArrayLike,mu: ArrayLike = 1) -> Array:
#     alpha = 1 / adx.semimajor_axis(r0_vec, v0_vec, mu)
